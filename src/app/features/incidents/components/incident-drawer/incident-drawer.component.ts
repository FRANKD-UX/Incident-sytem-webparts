      ...
      <div class="drawer" [class.open]="isOpen" (click)="$event.stopPropagation()">
        <div class="drawer__header">
          ...
          <div class="drawer__header-actions">
            <button class="btn-icon" (click)="refresh.emit()"><span class="material-icons">refresh</span></button>
          ...
          @if (loading()) {
            ...
            @switch (activeTab) {
              @case ("summary") {
                ...
                <app-chain-progress [chain]="chain()" [currentStepId]="incident?.currentDepartment?.id ?? ''" />
              }
              @case ("checklist") {
                <app-checklist-panel
              ...
              @case ("attachments") {
                <app-attachments-panel [incidentId]="incident!.id" [attachments]="attachments()" (attachmentsUpdated)="loadAttachments()" />
              }
              @case ("audit") {
                <app-audit-timeline [entries]="auditTrail()" />
              }
              @case ("escalations") {
                <app-escalation-panel [incidentId]="incident!.id" [escalations]="escalations()" />
              }
              @case ("sla") {
