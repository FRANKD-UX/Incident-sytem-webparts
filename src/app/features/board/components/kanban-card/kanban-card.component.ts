...
@Component({
  ...
  template: `
    <div
      ...
      [class.completed]="incident.status === 'RESOLVED' || incident.status === 'CLOSED'"
    ...
    >
      ...
      <div class="card-meta">
        ...
        <div class="meta-row">
          <app-status-badge [status]="incident.status" [compact]="true" />
        </div>
...
export class KanbanCardComponent {
  ...
  onDragStart(event: DragEvent): void {
    ...
    if (event.dataTransfer) {
      ...
      event.dataTransfer.setData("text/plain", this.incident.id);
      event.dataTransfer.setData("application/x-incident-id", this.incident.id);
      event.dataTransfer.setData(
        "application/x-source-department-code",
        this.incident.currentDepartment.code,
      );
    }
